...
public class GameManager : MonoBehaviour
{
    ...
    private bool IsOrderCorrect()
    {
        ...
        if(burger.PattyAmount != currentTicket.PattyAmount || burger.LettuceAmount != currentTicket.LettuceAmount || burger.CheeseAmount != currentTicket.CheeseAmount
            || burger.CowTongueAmount != currentTicket.CowTongueAmount || burger.GreenBristolAmount != currentTicket.GreenBristolAmount || burger.BlueRingAmount != currentTicket.PurpleBristolAmount || burger.BunAmount != 1)
        {
